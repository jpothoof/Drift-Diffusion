...
T = 298  # K
f = kb * T / q  # Volts
mu_n_1 = 1e-14  # m^2/V*s
mu_p_1 = 1e-13  # m^2/V*s
#6e-14
mu_n_2 = 1e-14  # m^2/V*s
mu_p_2 = 3e-13  # m^2/V*s
Dn_1 =f * mu_n_1  # m^2/s
Dp_1 = f * mu_p_1  # m^2/s
Dn_2 =f * mu_n_2
Dp_2 = f * mu_p_2
...
eq = Pion_equation & Nion_equation & potential_equation & Electron_equation & Hole_equation
...
np.savetxt('potential_four_species_27.txt', potential_save, delimiter='\t')
#potential_four_species_26.txt